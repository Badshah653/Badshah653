...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: Badshah(@badshah,@badshah",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "badshah_Player"
    usar = user
    wew = usar.id
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 𝐏𝐥𝐚𝐞𝐚𝐬𝐞 ❤️ 𝐌𝐚𝐧𝐮𝐚𝐥𝐥𝐲 🥀 𝐀𝐝𝐝 💫 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 😔 𝐎𝐫 🎸 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 ❤️ 𝐓𝐨 : @badshah7867 🥀** ")
   ...
   try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://te.legra.ph/file/d3a780f08b7182feabbcc.jpg"
            ...
            [
                [
                        InlineKeyboardButton(
                            ...
                            url=f"https://t.me/apniyaarijaansepyari")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/149ee7f9b7912f6541a44.jpg", 
                             caption="**💥 𝐀𝐥𝐢𝐬𝐡𝐚 🔈 𝐌𝐮𝐬𝐢𝐜🤞𝐍𝐨𝐰 🥀\n▶️ 𝐏𝐚𝐮𝐬𝐞𝐝 🌷 ...**"
    )
